...
import com.example.configuration.TalkResource;
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        switch (event.getName()){
            case "startmafia":
                ...
                if (member != null) {
                    TalkResource textToSpeech = new TalkResource("hello");
                    ...
                    if (voiceState != null && voiceState.inAudioChannel()) {
                        ...
                        for (Member channelMember : members) {
                            if (count != 0 ){
                                ...
                                if(role.getRole().equals("godfather") || role.getRole().equals("negotiator") ||role.getRole().equals("normalmafia")){
                        ...
                        for(Player p : mafiaPlayers){
                            ...
                            channelMember.getUser().openPrivateChannel()
                                    .flatMap(privateChannel -> privateChannel.sendMessage("The Mafia team is: " + mafianames))
                                    .queue();
                        }
            ...
            case "reportnight":
                ReportNight();
            case "analyzenight":
                String result = game.analyzeNight() + "there is currently " + game.getPlayers().size() + " Players in the game.";
                ...
                if (options.isEmpty() == false) {
                    ...
                    for(int i = 0; i < game.getPlayers().size(); i++){
                        ...
                        if(temp.getName().equals(removePlayer)){
                            ...
                            textChannel.get(0).sendMessage("The following played has been successfully voted out: " + removePlayer).queue();
                            return;
                        }
                    }
                } else {
    ...
    public void startDay(int time){
        ...
        for(Player player : this.game.getPlayers()){
           ...
           // Send a message to the player
            ...
            if (member != null) {
                String message = "/tts Turn: " + member.getEffectiveName();
