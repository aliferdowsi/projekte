...
public class DiscordBot {
        ...
        public static void main(String[] args) throws LoginException {
                ...
                jda
                                ...
                                .queue();
                jda
                                .upsertCommand("analyzenight",
                                                "This command analyz what happened at night and tells the users")
                                .setGuildOnly(false)
                                .queue();
                jda
                                .upsertCommand("reportnight",
                                                "This command reports what happened at night (ONLY FOR DEBUGGING)")
                                .setGuildOnly(false)
                                .queue();
                jda
